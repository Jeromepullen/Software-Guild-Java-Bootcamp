...
insert into Customer values (1,'John', 'Smith', '333 Third St','555-555-5555','Novel','john@novel.com'),(2,'Lindsay', 'Lohan', 'Lohan Lane','555-555-5555','Lohan Inc','lindsay@lohan.com');
...
insert into User values (1,'Jerome','jerome@gmail.com','password',1,'Jerome','Pullen'),(2,'Jeff','jeff@gmail.com','password',1,'Jeff','Thomas'),(3,'Alice','alice@gmail.com','password',1,'Alice','Glass');
create table `Order` (
